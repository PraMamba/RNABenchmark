...
class GENALMForMaskedLM(BertPreTrainedModel):
...
class GENALMForNextSentencePrediction(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class GENALMForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class GENALMForMultipleChoice(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
...
class GENALMForTokenClassification(BertPreTrainedModel):
...
class GENALMForQuestionAnswering(BertPreTrainedModel):
